= REST API Level 0 - Eclipse Vert.x Booster  ( check!)
== Run this Booster Locally
( hello )rewrewrewrewrew

To run this booster on your local host:

[source,bash,options="nowrap",subs="attributes+"]fdsfdsfdsfds
----
$ git clone git@github.com:${loggedUser}/okagain
